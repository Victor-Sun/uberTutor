...
@Entity
@Table(name="PM_ISSUE_KB")
public class IssueKBEntity{

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO,generator="PM_ISSUE_KB_SEQ")     
	@SequenceGenerator(name="PM_ISSUE_KB_SEQ", sequenceName="PM_ISSUE_KB_SEQ")
	private Long id;
