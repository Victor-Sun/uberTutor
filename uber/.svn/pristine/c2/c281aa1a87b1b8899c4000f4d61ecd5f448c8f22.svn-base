...
@Namespace("/pm")
public class ProjectExtensionPlanAction extends PDMSCrudActionSupport<Ext103ListEntity> {
...
//			 fields: ['id','department','stageId','planStartDate','planEndDate','ratio','total','completed','progress'],
			...
			if(map.get("PROGRESS") != null){
				BigDecimal ratio = ((BigDecimal)map.get("PROGRESS")).multiply(new BigDecimal(100));
	...
	public void getExtStagePartProgressList(){
		JsonResult result = new JsonResult();
		List<Map<String,Object>> data = new ArrayList<Map<String,Object>>();
		List<Map<String, Object>> list = projectExtensionPlanService.getExtStagePartProgressList(Long.valueOf(stageId));
		for(Map<String, Object> map:list){
			Map<String,Object> dataMap = new HashMap<String,Object>();
			dataMap.put("id", map.get("ITEM_ID"));
			dataMap.put("stageId", map.get("STAGE_ID"));
	...
	public void importPartInfoFromExcel() {
		try{
			String loginUserId = SessionData.getLoginUserId();
			projectExtensionPlanService.importProgramFromExcel(extProjectId,uploadFileName, new FileInputStream(upload), loginUserId);
	...
	public void getChecklistList(){
		JsonResult result = new JsonResult();
		List<Map<String,Object>> data = new ArrayList<Map<String,Object>>();
		List<Map<String, Object>> list = projectExtensionPlanService.getExt201TaskCheckList(taskId);
		for(Map<String, Object> map:list){
			Map<String,Object> dataMap = new HashMap<String,Object>();
	...
	public void downloadExt203Template() {
		try {
			InputStream is = this.getClass().getResourceAsStream("/template/wbsTemplate.mpp");
			HttpServletResponse response = Struts2Utils.getResponse();
			ServletOutputStream os = response.getOutputStream();
			response.reset();// 清空输出流
			// filename = "attachment; filename=" + filename + ".xls";
			response.setHeader("Content-disposition","attachment; filename=wbsTemplate.mpp");// 设定输出文件头
			response.setContentType("application/msexcel");// 定义输出类型
			try {
				int l = -1;
				byte[] tmp = new byte[1024];
	...
	public void getExt201ContralList(){
		JsonResult result = new JsonResult();
		List<Map<String,Object>> data = new ArrayList<Map<String,Object>>();
		List<Map<String, Object>> list = projectExtensionPlanService.getExt201ContralList(Long.valueOf(extProjectId));
		for(Map<String, Object> map:list){
			Map<String,Object> dataMap = new HashMap<String,Object>();
			dataMap.put("sourcingType", map.get("SOURCING_TYPE"));
			dataMap.put("itemNo", map.get("ITEM_NO"));
			dataMap.put("itemName", map.get("ITEM_NAME"));
			dataMap.put("userName", map.get("USERNAME"));
			dataMap.put("obsName", map.get("OBS_NAME"));
			dataMap.put("severityLevel", map.get("SEVERITY_LEVEL"));
			dataMap.put("devType", map.get("DEV_TYPE"));
			dataMap.put("isSe", map.get("IS_SE"));
			dataMap.put("productionToolingPeriod", map.get("PRODUCTION_TOOLING_PERIOD"));
			dataMap.put("status", map.get("STATUS"));
			dataMap.put("[D1数据评审]_PLANNED_START_DAT", ObjectConverter.convert2String(map.get("[D1数据评审]_PLANNED_START_DAT")));
			dataMap.put("[D1数据评审]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[D1数据评审]_ACTUAL_START_DATE")));
			dataMap.put("[D1数据评审]_PLANNED_FINISH_DA", ObjectConverter.convert2String(map.get("[D1数据评审]_PLANNED_FINISH_DA")));
			dataMap.put("[D1数据评审]_ACTUAL_FINISH_DAT", ObjectConverter.convert2String(map.get("[D1数据评审]_ACTUAL_FINISH_DAT")));
			dataMap.put("[D1数据发布]_PLANNED_START_DAT", ObjectConverter.convert2String(map.get("[D1数据发布]_PLANNED_START_DAT")));
			dataMap.put("[D1数据发布]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[D1数据发布]_ACTUAL_START_DATE")));
			dataMap.put("[D1数据发布]_PLANNED_FINISH_DA", ObjectConverter.convert2String(map.get("[D1数据发布]_PLANNED_FINISH_DA")));
			dataMap.put("[D1数据发布]_ACTUAL_FINISH_DAT", ObjectConverter.convert2String(map.get("[D1数据发布]_ACTUAL_FINISH_DAT")));
			dataMap.put("[INTERFACE1]_PLANNED_START_DA", ObjectConverter.convert2String(map.get("[INTERFACE 1]_PLANNED_START_DA")));
			dataMap.put("[INTERFACE1]_ACTUAL_START_DAT", ObjectConverter.convert2String(map.get("[INTERFACE 1]_ACTUAL_START_DAT")));
			dataMap.put("[INTERFACE1]_PLANNED_FINISH_D", ObjectConverter.convert2String(map.get("[INTERFACE 1]_PLANNED_FINISH_D")));
			dataMap.put("[INTERFACE1]_ACTUAL_FINISH_DA", ObjectConverter.convert2String(map.get("[INTERFACE 1]_ACTUAL_FINISH_DA")));
			dataMap.put("[INTERFACE2]_PLANNED_START_DA", ObjectConverter.convert2String(map.get("[INTERFACE 2]_PLANNED_START_DA")));
			dataMap.put("[INTERFACE2]_ACTUAL_START_DAT", ObjectConverter.convert2String(map.get("[INTERFACE 2]_ACTUAL_START_DAT")));
			dataMap.put("[INTERFACE2]_PLANNED_FINISH_D", ObjectConverter.convert2String(map.get("[INTERFACE 2]_PLANNED_FINISH_D")));
			dataMap.put("[INTERFACE2]_ACTUAL_FINISH_DA", ObjectConverter.convert2String(map.get("[INTERFACE 2]_ACTUAL_FINISH_DA")));
			dataMap.put("[SRC 1]_PLANNED_START_DATE", ObjectConverter.convert2String(map.get("[SRC 1]_PLANNED_START_DATE")));
			dataMap.put("[SRC 1]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[SRC 1]_ACTUAL_START_DATE")));
			dataMap.put("[SRC 1]_PLANNED_FINISH_DATE", ObjectConverter.convert2String(map.get("[SRC 1]_PLANNED_FINISH_DATE")));
			dataMap.put("[SRC 1]_ACTUAL_FINISH_DATE", ObjectConverter.convert2String(map.get("[SRC 1]_ACTUAL_FINISH_DATE")));
			dataMap.put("[SRC 2]_PLANNED_START_DATE", ObjectConverter.convert2String(map.get("[SRC 2]_PLANNED_START_DATE")));
			dataMap.put("[SRC 2]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[SRC 2]_ACTUAL_START_DATE")));
			dataMap.put("[SRC 2]_PLANNED_FINISH_DATE", ObjectConverter.convert2String(map.get("[SRC 2]_PLANNED_FINISH_DATE")));
			dataMap.put("[SRC 2]_ACTUAL_FINISH_DATE", ObjectConverter.convert2String(map.get("[SRC 2]_ACTUAL_FINISH_DATE")));
			dataMap.put("[OTS1]_PLANNED_START_DATE", ObjectConverter.convert2String(map.get("[OTS1]_PLANNED_START_DATE")));
			dataMap.put("[OTS1]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[OTS1]_ACTUAL_START_DATE")));
			dataMap.put("[OTS1]_PLANNED_FINISH_DATE", ObjectConverter.convert2String(map.get("[OTS1]_PLANNED_FINISH_DATE")));
			dataMap.put("[OTS1]_ACTUAL_FINISH_DATE", ObjectConverter.convert2String(map.get("[OTS1]_ACTUAL_FINISH_DATE")));
			dataMap.put("[OTS2]_PLANNED_START_DATE", ObjectConverter.convert2String(map.get("[OTS2]_PLANNED_START_DATE")));
			dataMap.put("[OTS2]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[OTS2]_ACTUAL_START_DATE")));
			dataMap.put("[OTS2]_PLANNED_FINISH_DATE", ObjectConverter.convert2String(map.get("[OTS2]_PLANNED_FINISH_DATE")));
			dataMap.put("[OTS2]_ACTUAL_FINISH_DATE", ObjectConverter.convert2String(map.get("[OTS2]_ACTUAL_FINISH_DATE")));
			dataMap.put("[DV1]_PLANNED_START_DATE", ObjectConverter.convert2String(map.get("[DV1]_PLANNED_START_DATE")));
			dataMap.put("[DV1]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[DV1]_ACTUAL_START_DATE")));
			dataMap.put("[DV1]_PLANNED_FINISH_DATE", ObjectConverter.convert2String(map.get("[DV1]_PLANNED_FINISH_DATE")));
			dataMap.put("[DV1]_ACTUAL_FINISH_DATE", ObjectConverter.convert2String(map.get("[DV1]_ACTUAL_FINISH_DATE")));
			dataMap.put("[DV2]_PLANNED_START_DATE", ObjectConverter.convert2String(map.get("[DV2]_PLANNED_START_DATE")));
			dataMap.put("[DV2]_ACTUAL_START_DATE", ObjectConverter.convert2String(map.get("[DV2]_ACTUAL_START_DATE")));
			dataMap.put("[DV2]_PLANNED_FINISH_DATE", ObjectConverter.convert2String(map.get("[DV2]_PLANNED_FINISH_DATE")));
			dataMap.put("[DV2]_ACTUAL_FINISH_DATE", ObjectConverter.convert2String(map.get("[DV2]_ACTUAL_FINISH_DATE")));
