Ext.define('uber.view.tutor.OpenRequestController',{
	extend: 'Ext.app.ViewController',
	alias: 'controller.openRequest',
	
	init: function (view) {
        // Updates the activeState config of View.
        view.updateActiveState = this.updateActiveState.bind(this);
    },
    
    onSubjectsClick: function(btn, menuitem) {
