...
CREATE OR REPLACE VIEW SESSION_INFO AS
	SELECT REQUEST.ID AS REQUEST_ID, CATEGORY.TITLE AS CATEGORY, SUBJECT.TITLE AS SUBJECT, USERS.ID AS STUDENT_ID, USERS.FULLNAME AS STUDENT_NAME, TUTOR.ID AS TUTOR_ID, TUTOR.FULLNAME AS TUTOR_NAME, REQUEST.TITLE, REQUEST.DESCRIPTION, REQUEST.CREATE_DATE, REQUEST.UPDATE_DATE, REQUEST.PENDING_DATE, REQUEST.PROCESS_DATE, REQUEST.CLOSE_DATE, REQUEST.CANCEL_DATE, REQUEST.DESCRIPTION AS SUBJECT_DESCRIPTION, REQUEST.STATUS, REQUEST.TITLE AS REQUEST_TITLE
