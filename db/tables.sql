...
CREATE OR REPLACE VIEW V_AVAILABLE_REQUESTS AS
	SELECT REQUEST.ID AS REQUEST_ID, USERS.ID AS USER_ID, USERS.FULLNAME AS USER_FULLNAME, SUBJECT.TITLE AS SUBJECT_TITLE, REQUEST.CREATE_DATE, SUBJECT.ID AS SUBJECT_ID, TUTOR_SUBJECT.USER_ID AS TUTOR_ID, REQUEST.STATUS, REQUEST.TITLE AS REQUEST_TITLE
