...
CREATE OR REPLACE VIEW USER_FEEDBACK AS
	SELECT USERS.FULLNAME, FEEDBACK.TUTOR_ID, FEEDBACK.CREATE_DATE, FEEDBACK.RATING, FEEDBACK.FEEDBACK, REQUEST.FEEDBACK AS FEEDBACK_ID, REQUEST.ID AS REQUEST_ID
	FROM USERS
	RIGHT OUTER JOIN FEEDBACK
