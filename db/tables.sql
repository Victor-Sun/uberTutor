...
CREATE OR REPLACE VIEW V_AVAILABLE_REQUESTS AS
	SELECT REQUEST.ID AS REQUEST_ID, USERS.ID AS USER_ID, USER_RATING.AVERAGE_RATING, USERS.FULLNAME AS USER_FULLNAME, SUBJECT.TITLE AS SUBJECT_TITLE, REQUEST.CREATE_DATE, SUBJECT.ID AS SUBJECT_ID, TUTOR_SUBJECT.USER_ID AS TUTOR_ID, REQUEST.STATUS, REQUEST.TITLE AS REQUEST_TITLE
	FROM USER_SUBJECT TUTOR_SUBJECT
	INNER JOIN SUBJECT
	ON TUTOR_SUBJECT.SUBJECT_ID = SUBJECT.ID
	INNER JOIN USER_REQUEST REQUEST
	ON REQUEST.SUBJECT_ID = SUBJECT.ID AND REQUEST.STATUS = 'OPEN'
	INNER JOIN USERS
	ON USERS.ID = REQUEST.USER_ID
	INNER JOIN V_USER_RATING USER_RATING
	ON USERS.ID = USER_RATING.USER_ID;
