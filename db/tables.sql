...
CREATE OR REPLACE VIEW V_USER_FEEDBACK AS
	SELECT USERS.FULLNAME, USERS.ID AS USER_ID, FEEDBACK.CREATE_DATE, FEEDBACK.RATING, FEEDBACK.FEEDBACK, REQUEST.FEEDBACK AS FEEDBACK_ID, REQUEST.ID AS REQUEST_ID, REQUEST.TUTOR_ID
	FROM USERS
	INNER JOIN USER_REQUEST REQUEST
	ON REQUEST.USER_ID = USERS.ID
	INNER JOIN FEEDBACK
	ON REQUEST.FEEDBACK = FEEDBACK.ID;
