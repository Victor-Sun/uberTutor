...
CREATE OR REPLACE VIEW USER_SESSIONS AS 
	SELECT REQUEST.ID AS REQUEST_ID, REQUEST.OPEN_DATE, REQUEST.USER_ID AS STUDENT_ID, USERS.FULLNAME AS STUDENT_NAME, REQUEST.TUTOR_ID, TUTOR.FULLNAME AS TUTOR_NAME, CATEGORY.TITLE AS CATEGORY, SUBJECT.TITLE AS SUBJECT, REQUEST.STATUS AS STATUS 
...
INSERT ALL
	INTO USER_REQUEST (ID, USER_ID,TUTOR_ID, SUBJECT_ID, STATUS, DESCRIPTION, OPEN_DATE, UPDATE_DATE) VALUES('1', '1', '2', '1', 'CLOSED', 'Request Description', SYSDATE, SYSDATE)
	INTO USER_REQUEST (ID, USER_ID,TUTOR_ID, SUBJECT_ID, STATUS, DESCRIPTION, OPEN_DATE, UPDATE_DATE) VALUES('2', '1', '2', '2', 'CLOSED', 'Request Description', SYSDATE, SYSDATE)
	INTO USER_REQUEST (ID, USER_ID,TUTOR_ID, SUBJECT_ID, STATUS, DESCRIPTION, OPEN_DATE, UPDATE_DATE) VALUES('3', '1', '2', '2', 'OPEN', 'Request Description', SYSDATE, SYSDATE)
SELECT * FROM DUAL;
