...
INSERT ALL
	INTO SCHOOLS (ID, NAME, CITY, STATE) VALUES ('1', 'PICK A SCHOOL', 'CITY', 'STATE')
	INTO SCHOOLS (ID, NAME, CITY, STATE) VALUES ('2', 'GRAND VALLEY STATE UNIVERSITY', 'ALLENDALE', 'MI')
	INTO SCHOOLS (ID, NAME, CITY, STATE) VALUES ('3', 'UNIVERSITY OF MICHIGAN', 'ANN ARBOR', 'MI')
SELECT * FROM DUAL;
...
INSERT ALL
	INTO SUBJECT_CATEGORY(ID, TITLE) VALUES('1', 'PICK A CATEGORY')
	INTO SUBJECT_CATEGORY(ID, TITLE) VALUES('2', 'Math')
	INTO SUBJECT_CATEGORY(ID, TITLE) VALUES('3', 'CS')
SELECT * FROM DUAL;

INSERT ALL
	INTO SUBJECT(ID, TITLE, DESCRIPTION, CATEGORY_ID) VALUES('1', 'PICK A SUBJECT', 'SUBJECT', '1')
	INTO SUBJECT(ID, TITLE, DESCRIPTION, CATEGORY_ID) VALUES('2', 'Algebra', 'Algebra 1', '2')
	INTO SUBJECT(ID, TITLE, DESCRIPTION, CATEGORY_ID) VALUES('3', 'Java', 'Java', '3')
SELECT * FROM DUAL;
