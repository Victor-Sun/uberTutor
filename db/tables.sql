...
CREATE OR REPLACE VIEW USERS_SUBJECT AS
	SELECT SUBJECT.ID, SUBJECT.TITLE, User_Subject.User_Id 
	FROM USER_SUBJECT, SUBJECT 
	WHERE USER_SUBJECT.SUBJECT_ID = SUBJECT.ID;
        
CREATE OR REPLACE VIEW USERS_CATEGORY AS
	SELECT SUBJECT_CATEGORY.ID AS CATEGORY_ID, SUBJECT_CATEGORY.TITLE AS CATEGORY_TITLE,SUBJECT.ID AS SUBJECT_ID 
	FROM SUBJECT_CATEGORY, SUBJECT 
	WHERE SUBJECT.CATEGORY_ID = SUBJECT_CATEGORY.ID;

CREATE OR REPLACE VIEW USERS_SUBJECT_CATEGORY AS
	SELECT SUBJECT.ID AS SUBJECT_ID, SUBJECT.TITLE AS SUBJECT_TITLE, SUBJECT_CATEGORY.ID AS CATEGORY_ID, SUBJECT_CATEGORY.TITLE AS CATEGORY_TITLE
